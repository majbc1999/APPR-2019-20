...
Nato sem naredil še predikcijo za energetske vire, ki se izražajo v TJ. Poskušal sem napovedati spreminjanje deleža teh virov (odstotka) do leta 2030. Predpostavil sem, da se količina vira spreminja v skladu z logaritemsko funkcijo (da ne bi bilo naraščanje preseglo 100%). Kot lahko vidimo v grafu deleža porab, se bo delež daljinske toplote vse bolj zmanjševal in ga bo leta 2030 le še za slabo tretjino. Delež sončne energije naj se nebi spreminjal, po drugi strani pa bo precej narasel delež toplote iz okolice.
...
```{r zemljevid1, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, results='hide', fig.width=15, fig.height=5}
print(zemljevid1)
```
...
```{r zemljevid2, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, results='hide', fig.width=15, fig.height=5}
print(zemljevid2)
```
...
```{r zemljevid3, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, results='hide'}
print(zemljevid3)
```
